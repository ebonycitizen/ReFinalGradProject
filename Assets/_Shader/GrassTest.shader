Shader "Roystan/GrassTest"
{
	Properties
	{
		...
		_WindStrength("Wind Strengtth",Float) = 1
		...
		#include"Assets/_Shader/CustomTessellation.cginc"
		...
		void geo(triangle vertexOutput IN[3], inout TriangleStream<geometryOutput> triStream)
		{
			...
			float3 wind = normalize(float3(windSample.x, windSample.y, 1));
